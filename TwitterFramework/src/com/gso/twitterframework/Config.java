...
public class Config {
	...
	public static String CONSUMER_KEY = "mpaQ9GA3ICVbnZTZH2FEdg"; // set from implement project
	public static String CONSUMER_SECRET = "BH37EUqAHc1vAnxvdS2X4fJsxxuZRCJlT6VtT4avQNI";// set from implement project
